...
Modernamente, as principais \structure{teorias da população} surgiram com base no \structure{princípio da população}, apresentado, no final do século XVIII, por \structure{Thomas Robert Malthus}.

- Com base no debate, questionamento, refutação e reformulação das proposições *malthusianas*, surgiram novas teorias, no qual se destacam:
...
- Os **otimistas** também acreditavam na racionalidade do indivíduo para regular a sua própria reprodução.
...
O \structure{princípio da população} de Malthus
...
Dentro desse panaroma a crítica mais radical às ideias de Malthus provém de \structure{Karl Marx}, que se não chega a formular uma teoria da população, nem a desenvolver as sugestões que lança sobre o modo de conformação social da fecundidade, assume uma perspectiva histórica ante os fenômenos do homem (humanidade) que destrói os fundamentos da interpretação Malthusiana.
...
- o controle de natalidade representava uma ecolha dos indivíduos, dadas suas condições materiais e sua vontade de ter filhos.
...
Assim, para essa corrente, a única saída para os problemas expostos seria o controle de natalidade.
