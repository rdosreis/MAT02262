...
- O período chamado de \structure{pré-estatístico} caracteriza-se por apresentar não apenas a **inexistência**, mas também uma ausência de preocupação específica com o **registro de informações** destinadas à posteridade.
- A materialidade encontrada nesse peródo é condsiderada, assim, residual.

## Paleodemografia {.allowframebreaks}

- O \structure{estudo das primeiras populações humanas} caracteriza-se por uma carência completa de estatísticas, própria da pré-história e dos povos que não nos legaram testemunhos escritos.
...
+ Esse é o campo da \structure{paleodemografia}.
...
- As civilizações da antiga \structure{Mesopotâmia} \underline{realizavam censos}, com a finalidade de \underline{cobrar tributos}.
- No \structure{Egito Antigo} e na \structure{civilização greco-romana}, os censos eram essenciais para \underline{controle} e \underline{administração dos impérios}.
...
- De um povo pastoril a centro de um Império em dez séculos, \structure{os romanos} mostraram, desde os censos de Sérvio Túlio (555 a.C.), uma notável  \structure{evolução na coleta de informações periódicas} junto às famílias, com \structure{72 censos registrados} até 72 d.C., apresentando uma média de um censo realizado a pouco menos de sete anos. 
...
```{r echo=FALSE, fig.align='right', message=FALSE, warning=FALSE, out.width='30%', out.height='23%', paged.print=FALSE}
...
- As \structure{pesquisas senhoriais} foram muito comuns durante a Idade Média, em particular na \underline{França} e na \underline{Inglaterra}, mas desapareceram quando a servidão deu lugar a uma economia monetária, dando espaço às \structure{pesquisas fiscais}, sendo a mais famosa e antiga o \structure{Domesday Book} na Inglaterra.
...
- É importante ressaltar os registros de contagens realizadas na \structure{América pré-colombiana} por \structure{maias} e \structure{incas}.
...
- **listas eleitorais e militares**;
- **relação de fiéis que comungam**; 
- **correspondência e relatos de viajantes**.
...
- **listas administrativas:** de passaportes concedidos, de entrada e saída de portos.
...
- Dados sobre **etnia**, **gênero**, **idade**, **estado civil**, **grau de escolaridade**, **nível de renda**, **dispersão territorial** e **movimentos migratórios**.
...
2. Houve, no período, um **aperfeiçoamento da teoria das probabilidades** e **estatística inferencial**, com a aplicação da **teoria da distribuição normal** por \structure{Aldophe Quételet (1796-1874)} no estudo de diversas características das populações humanas: altura, peso, natalidade, mortalidade, renda, entre outras.
...
3. O debate e a difusão de teorias demográficas.
    - O *Ensaio*, de \structure{Malthus}, recebeu várias edições ao longo do século XIX incorporando o debate sobre o \structure{princípio da população}, o que mostra sem grande esforço, a grande discussão suscitada pela _**tese malthusiana**_.
...
- Os anos de 1860 a 1910 podem ser caracterizados como um período de transição, em que a demografia emergiu das estatísticas como um **campo de interesse separado**. 
    + \structure{Adolphe Quételet (1796-1874)}, \structure{William Farr (1807-1883)}, \structure{Louis-Adolphe Bertillon (1821-1883)}, \structure{Jacques Bertillon (1851-1922)}, \structure{Joseph Körösi (1844-1906)}, \structure{Anders Nicolas Kaier (1838-1919)}, \structure{Richard Böckh (1824-1907)}, \structure{Émile Durkheim (1858-1917)}, \structure{Wilhelm Lexis (1837-1914)} e \structure{Luigi Bodio (1840-1920)} contribuíram para o **desenvolvimento de ferramentas de métodos** e **técnicas de análise demográfica**.
...
- É necessário reconhecer que, no que diz respeito a realização de censos, houve notório avanço em relação ao trinômio 

\begin{center}
\structure{impostos - controle social - contingentes militares}.
\end{center}
...
- Um dos propósitos da ONU foi o de **padronizar as estatísticas socioeconômicas** de seus países-membros, permitindo a elaboração de diagnósticos e análises que possibilitassem a criação de políticas para o desenvolvimento.
