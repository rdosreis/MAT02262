## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='90%', out.height='70%'----

knitr::include_graphics(here::here('imagens', 'razao_sexos_total.png'))



## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='100%', out.height='80%'----

knitr::include_graphics(here::here('imagens', 'razao_sexos_total_graf.png'))



## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='50%', out.height='80%'----
