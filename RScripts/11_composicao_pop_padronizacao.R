...
## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='75%', out.height='80%'----

knitr::include_graphics(here::here('imagens', 'taxa_padronizada_01.png'))



## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='75%', out.height='60%'----
...
## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='75%'------------------

knitr::include_graphics(here::here('imagens', 'taxa_padronizada_05.png'))



## ----echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='85%'------------------
